...
Quanto ao \textbf{primeiro objetivo específico}, a calibração empírica mostrou que o
mínimo do número de comparações --- métrica determinística --- é estável em
$M \approx 20$--$25$, enquanto o mínimo de tempo é sensível a ruído e variou entre 40
e 100. Adotou-se o critério do menor $M$ dentro de 2\% do melhor tempo, que conduz a
$M = 40$ na maioria das células. Esse valor é superior à faixa de 5 a 25 recomendada
por \citeonline{sedgewick1978}, diferença atribuída à evolução do hardware: em
processadores atuais, a localidade de cache e a previsibilidade de desvios do
Insertion Sort deslocam o ponto de equilíbrio para valores maiores.

Quanto ao \textbf{segundo objetivo}, as versões híbridas reduziram o tempo de
execução entre 16\% e 54\% em relação ao Quicksort recursivo puro, com mediana de
28\%, sem prejuízo em nenhuma configuração testada. O ganho foi maior nas massas com
...
aproximadamente 2.000 vezes em número de comparações e 1.200 vezes em tempo de
execução.
...
mesmo valor de $M$}, não apresenta vantagem sistemática: reduz as comparações em 2\%
