...
Elemento central & 10.000 & 100 & 20 \\
...
é estável em $M \approx 20$--$25$ nas seis células. O \textbf{mínimo de tempo}, ao
contrário, variou entre 40 e 100 conforme a célula, pois o platô é plano e o
\textit{argmin} passa a ser determinado por ruído de medição. O critério do menor $M$
dentro de 2\% do melhor tempo conduz a $M = 40$ em cinco das seis células; a única
exceção (pivô central, $n = 10^4$) é justamente a que evidencia a instabilidade do
critério de tempo. Adotou-se $M = 40$ nos experimentos subsequentes por ser o valor
recomendado na maioria das células e por manter o Insertion Sort restrito a subvetores
pequenos.
