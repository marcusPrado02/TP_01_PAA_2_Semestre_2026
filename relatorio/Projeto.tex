...
% Comandos de estilo usados pelo abntcite.sty e pelo abnt-alf.bst, cujas
% definicoes foram comentadas (marcadas com %%EDITADO) no proprio abntcite.sty
% (linhas 407-411). Sem elas, \citeonline e \cite falham com
% "Undefined control sequence". Definidos aqui para nao alterar a biblioteca.
...
% ATENCAO: o enunciado prevê grupos de 2 a 4 alunos.
% Acrescente aqui os demais integrantes do grupo, separados por \par.
\autor{ Marcus Prado Silva \par Pedro Henrique Vilaça Valverde \par Gabriel El Dine Breguez da Cunha }
...
\titulo{ESTUDO COMPARATIVO DE IMPLEMENTAÇÕES DO ALGORITMO QUICKSORT}
...
% Texto
\comentario{Trabalho Prático da disciplina de Projeto e Análise de Algoritmos, apresentado ao Instituto de Ciências Exatas e Informática da Pontifícia Universidade Católica de Minas Gerais.\par Professor: Walisson Ferreira de Carvalho}
